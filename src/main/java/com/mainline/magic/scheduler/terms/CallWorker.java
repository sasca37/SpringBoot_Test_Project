...
@Slf4j
public class CallWorker extends BaseWorker implements Callable<Terms>{
	private Terms terms;
	private UserTermsService termsService;
	private SchedulerService schedulerService;

	public CallWorker(Terms terms, UserTermsService termsService, SchedulerService schedulerService) {
		this.terms = terms;
